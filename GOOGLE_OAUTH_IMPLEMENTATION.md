...
- Redirect URI: `http://api.misbar.africa/api/auth/google/callback`
...
### Prerequisites
1. Backend server running on `http://api.misbar.africa`
2. Frontend running on `http://misbar.africa`
