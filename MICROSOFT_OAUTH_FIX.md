...
2. Under **Web** platform, ensure you have:
   - **Redirect URI**: `http://api.misbar.africa/api/auth/microsoft/callback`
...
2. **Go to your auth page** (`http://misbar.africa/auth`)
...
- **Development**: `http://api.misbar.africa/api/auth/microsoft/callback` ✅
