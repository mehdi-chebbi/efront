...
<div className="flex flex-wrap justify-center items-center gap-8 mb-12 pb-8 border-b border-gray-200">
  {[
    { name: 'ESA', url: 'https://www.esa.int/', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA7ja6pKcew6vsm5IThVhUyel9jPfr5RZAhw&s' },
    { name: 'Copernicus', url: 'https://www.copernicus.eu/en', logo: 'https://www.copernicus.eu/sites/default/files/styles/image_img_fluid/public/images/media/low/295955-Copernicus_logo_node_full_image_2.jpg?itok=rxBru8V4' },
    { name: 'NASA Earth', url: 'https://www.nasa.gov/', logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e5/NASA_logo.svg' },
    { name: 'Google Earth', url: 'https://earth.google.com/', logo: 'https://download.logo.wine/logo/Google_Earth/Google_Earth-Logo.wine.png' }
  ].map((partner) => (
    <div key={partner.name} className="flex items-center justify-center w-36 h-24 transition-all duration-300 opacity-100 border rounded-lg p-2 hover:scale-105">
...
{/* Middle Row - UN / Research Partners */}
<div className="flex flex-wrap justify-center items-center gap-8 mb-12 pb-8 border-b border-gray-200">
  {[
    { name: 'UN', url: 'https://www.un.org/', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Flag-United-Nations-Logo.jpg/1024px-Flag-United-Nations-Logo.jpg' },
    { name: 'UNESCO', url: 'https://en.unesco.org/', logo: 'https://upload.wikimedia.org/wikipedia/commons/b/bc/UNESCO_logo.svg' },
    { name: 'Adaptation Fund', url: 'https://www.adaptation-fund.org/', logo: 'https://www.adaptation-fund.org/wp-content/uploads/2023/06/logo.png' }
  ].map((partner) => (
    <div key={partner.name} className="flex items-center justify-center w-36 h-24 transition-all duration-300 opacity-100 border rounded-lg p-2 hover:scale-105">
      <a href={partner.url} target="_blank" rel="noopener noreferrer">
        <img src={partner.logo} alt={partner.name} className="w-full h-full object-contain"/>
...
{/* Bottom Row - African / Regional Partners */}
<div className="flex flex-wrap justify-center items-center gap-8">
  {[
    { name: 'African Union', url: 'https://au.int/', logo: 'https://au.int/sites/default/files/pages/31823-img-au_logo.jpg' },
    { name: 'GIZ', url: 'https://www.giz.de/en/html/index.html', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSTq66BuI190bnQhdHNVklCGtkgIzLe1nh4A&s' },
    { name: 'OSS', url: 'https://www.oss-online.org/', logo: 'https://www.oss-online.org/sites/default/files/logo-h.png' },
    { name: 'EU', url: 'https://europa.eu/', logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Flag_of_Europe.svg' }
  ].map((partner) => (
    <div key={partner.name} className="flex items-center justify-center w-36 h-24 transition-all duration-300 opacity-100 border rounded-lg p-2 hover:scale-105">
      <a href={partner.url} target="_blank" rel="noopener noreferrer">
        <img src={partner.logo} alt={partner.name} className="w-full h-full object-contain"/>
