    ...
    <div className="space-y-3">
      <div>
        ...
        <div className="space-y-3">
          {/* Indices Selection */}
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1 flex items-center space-x-2">
              <span>🔬</span>
          ...
          {hasDrawnArea && !startDate && !endDate && (
            <div className="nature-card rounded-lg p-3 border-l-4 border-yellow-500">
              <div className="flex items-center space-x-2">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-800 text-sm">Select Date Range</p>
                  <p className="text-xs text-gray-600 mt-1">Choose start and end dates to define the time period for analysis.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {hasDrawnArea && startDate && endDate && !selectedIndex && (
            <div className="nature-card rounded-lg p-3 border-l-4 border-purple-500">
              <div className="flex items-center space-x-2">
                <div className="flex-shrink-0">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-800 text-sm">Select Indices</p>
                  <p className="text-xs text-gray-600 mt-1">Choose one or more spectral indices to analyze for your selected area and time period.</p>
                </div>
              </div>
            </div>
          )}
