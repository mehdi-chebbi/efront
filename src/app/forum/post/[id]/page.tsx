...
export default function ForumPostPage() {
  ...
  const fetchPost = async () => {
    try {
      setLoading(true)
      const response = await fetch(`http://api.misbar.africa/api/forum/posts/${postId}`)
  ...
  const handleReply = async () => {
    ...
    try {
      const response = await fetch(`http://api.misbar.africa/api/forum/posts/${postId}/replies`, {
        method: 'POST',
        headers: {
